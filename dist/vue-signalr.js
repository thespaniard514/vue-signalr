  ...
  (0, _createClass3.default)(SocketConnection, [{
    ...
    value: function listen(method) {
      ...
      this.on('init', function () {
        _this3.socket.on(method, function () {
      ...
      if (this.$options.sockets) {
        ...
        methods.forEach(function (method) {
          ...
          Socket.on(method, function (data) {
            var _$options$sockets$met;

            return (_$options$sockets$met = _this6.$options.sockets[method]).call.apply(_$options$sockets$met, [_this6].concat((0, _toConsumableArray3.default)(data)));
          });
        });
      }
